...
After finding the paper *"Killing the Willing: 'Volunteers,' Suicide and Competency,*" 103 Michigan Law Review 939 (2005), by J. Blume, some of the differences in volunteerism may be due to the fact that whites commit suicide at two to three times the rates of blacks (the ethnic group with the highest rate is Alaskan Native/American Indian). In other words, for whites, voluntary execution represents a specific form of suicide: one in which the outcome is guaranteed (unlike trying to slit one's wrists in prison). The paper also mentions that those who volunteer to be executed were much more likely to have had substance abuse issues or have attempted suicide in the past. Finally, after noting that the issue of low black volunteerism has not received any attention in the academic literature, the paper quotes Mumia Abu-Jamal (of the "Free Mumia" campaigns in the 1990s) as saying: 

> The only discussion of this phenomenon is from a current death-row inmate, who
> has argued that most volunteers are white because prison is more of a stigma to white
> inmates and their families: 
> **"Blacks have a longer history of rejection from this society than
> the relatively recent era of grudging acceptance.**"

Could the volunteerism just be an artifact of the this phenomenon? Is it because, for blacks, being on death row isn't as shameful as it is for whites?
